...
class TransitioningAnimationController: NSObject,UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        guard /*let fromController = transitionContext.viewController(forKey: .from) as? UINavigationController, let todosTable = fromController.viewControllers.first as? UITableViewController,*/ let toController = transitionContext.viewController(forKey: .to) as? UINavigationController/*, let todoDetailTable = toController.viewControllers.first as? UITableViewController */else {
